...
namespace HR.LeaveManagement.Persistencce.Migrations
{
    ...
    [Migration("20230413093406_InitialMigration")]
            ...
            modelBuilder.Entity("HR.LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 4, 13, 9, 34, 6, 158, DateTimeKind.Utc).AddTicks(86),
                            DateModified = new DateTime(2023, 4, 13, 9, 34, 6, 158, DateTimeKind.Utc).AddTicks(89),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
